...
$arComponentParameters = array(
    ...
    'PARAMETERS' => array(
        ...
        'FORM_SUBTITLE' => Array(
            'NAME' => Loc::getMessage('SLAM_EASYFORM_SUBTITLE_FORM'),
            'TYPE' => 'STRING',
            'DEFAULT' => '',
            'PARENT' => 'BASE',
        ),
        ...
        'FORM_CLASS' => Array(
            'NAME' => Loc::getMessage('SLAM_EASYFORM_CLASS_FORM'),
            'TYPE' => 'STRING',
            'DEFAULT' => 'main-form-wrap',
            'PARENT' => 'BASE',
        ),
...
if (is_array($arFormFields)) {
    ...
    foreach ($arFormFields as $arVal) {
        ...
        //WIDTH
        $arComponentParameters['PARAMETERS']['CATEGORY_' . $arVal . '_CLASS'] = array(
            'PARENT' => 'CATEGORY_' . $arVal,
            'NAME' => 'Класс (general-itemInput_33 general-itemInput_half general-itemInput_25)',
            'DEFAULT' => 'general-itemInput',
            'TYPE' => 'STRING',
        );
