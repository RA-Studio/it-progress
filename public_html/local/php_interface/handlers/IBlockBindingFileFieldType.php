...
class IBlockBindingFile extends CUserTypeString
{
    ...
    function GetUserTypeDescription()
    {
        return array(
            ...
            "BASE_TYPE" => "file",
            "USER_TYPE" => "IF",
            "DESCRIPTION" => 'Привязка к инфоблоку с файлом',
            "CLASS_NAME" => "IBlockBindingFile",
            "GetSettingsHTML" => array("IBlockBindingFile", "GetSettingsHTML"),
            "GetPropertyFieldHtml" => array("IBlockBindingFile","GetPropertyFieldHtml"),
            "GetPropertyFieldHtmlMulty" => array("IBlockBindingFile", "GetPropertyFieldHtmlMulty"),
            "GetAdminListViewHTML" => array("IBlockBindingFile","GetAdminListViewHTML"),
            "ConvertToDB" => array("IBlockBindingFile","ConvertToDB"),
            "ConvertFromDB" => array("IBlockBindingFile","ConvertFromDB"),
        );
    }
