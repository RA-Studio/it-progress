...
?>
<form class="catalog-sort" action="#"><span>Сортировать по:</span>
    <div class="catalog-sort-item">
        <input type="radio" name="sort" id="radio1" checked>
        <label for="radio1">Виду учета</label>
    </div>
    <div class="catalog-sort-item">
        <input type="radio" name="sort" id="radio2">
        <label for="radio2">Назначению</label>
    </div>
</form>
